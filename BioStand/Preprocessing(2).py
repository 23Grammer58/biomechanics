...
class DataProcessing:
    ...
    def create_csv(self):
        ...
        for id, x in enumerate(self.json_files_average_strength):
            ...
            data['tenzo_2'].append(value_tenzo[2] / 47000)
            data['tenzo_0'].append(value_tenzo[0] / 43820.358326445)
            data['tenzo_3'].append(value_tenzo[3])
            data['mean_tenzo_0_2'].append((value_tenzo[0] / 43820.358326445 + value_tenzo[2] / 47000) / 2)
        ...
        data['correct_force_X(N)'] = np.array(data['mean_tenzo_0_2'])
        #Tenzo_0 43820.358326445
        #Tenzo_1 43820.358326445
        #Tenzo_2 47000
        #Tenzo_3 43820.358326445
        data['correct_force_Y(N)'] = np.array(data['mean_tenzo_1_3']) / 51095
        # print("-------------------------------------------------------------------------------------------------------------------------------------------------------------------")
        # print(type(data['correct_force_X']))
...
def main():
    ...
    tt = DataProcessing(r'C:\Users\Lenovo\PycharmProjects\MainBioStand\BioStand\files\IsoLatex','sd')
